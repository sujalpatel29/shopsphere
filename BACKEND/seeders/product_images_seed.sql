-- Seeder: product_images (Cloudinary images only)
-- Generated: 2026-03-13
-- IMPORTANT: Run migrations/add_product_images_columns.sql FIRST to add missing columns

-- Clear existing data
TRUNCATE TABLE `product_images`;

-- Insert product images (Cloudinary URLs only)
...
-- Product 18 (Samsung Galaxy Tab S9)
...
-- Product 22 (Apple Watch Ultra 2)
...
-- Product 23 (Samsung Galaxy Watch 6)
...
-- Product 27 (Bose SoundLink Flex)
...
-- Product 29 (PS5 Digital Edition)
...
-- Product 32 (Samsung Washing Machine)
