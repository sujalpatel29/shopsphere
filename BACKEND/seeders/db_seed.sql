...
-- 12. Offers
-- =====================
INSERT INTO offer_master (offer_id, offer_name, description, offer_type, discount_type, discount_value, maximum_discount_amount, min_purchase_amount, usage_limit_per_user, start_date, end_date, start_time, end_time, is_active, is_deleted, created_by, updated_by) VALUES
  (1, '10% off all phones',    'Get 10% discount on all phones above 10000.',      'category_discount', 'percentage',   10.00,   5000.00, 10000.00,  3, '2025-01-01 00:00:00', '2026-12-31 23:59:59', NULL, NULL, 1, 0, 1, 1),
  (2, '2000 off Android phones','Flat 2000 discount on Android phones above 15000.','category_discount', 'fixed_amount', 2000.00, 2000.00, 15000.00,  5, '2025-01-01 00:00:00', '2026-12-31 23:59:59', NULL, NULL, 1, 0, 1, 1),
  (3, 'iPhone 15 launch offer', 'Special launch discount on iPhone 15 Pro Max.',   'product_discount',  'fixed_amount', 5000.00, 5000.00, 120000.00, 2, '2025-01-01 00:00:00', '2026-12-31 23:59:59', NULL, NULL, 1, 0, 1, 1),
  (4, 'Flat 500 off orders above 5000', 'Get flat 500 discount on orders above 5000.', 'flat_discount', 'fixed_amount', 500.00, 500.00, 5000.00, 10, '2025-01-01 00:00:00', '2026-12-31 23:59:59', NULL, NULL, 1, 0, 1, 1),
  (5, '15% off Samsung phones', 'Get 15% discount on all Samsung phones above 20000.', 'category_discount', 'percentage', 15.00, 8000.00, 20000.00, 3, '2025-01-01 00:00:00', '2026-12-31 23:59:59', NULL, NULL, 1, 0, 1, 1),
  (6, '3000 off Galaxy S series', 'Flat 3000 discount on Galaxy S series phones.', 'product_discount', 'fixed_amount', 3000.00, 3000.00, 100000.00, 2, '2025-01-01 00:00:00', '2026-12-31 23:59:59', NULL, NULL, 1, 0, 1, 1),
  (7, '20% off Laptops', 'Get 20% discount on all laptops above 50000.', 'category_discount', 'percentage', 20.00, 10000.00, 50000.00, 2, '2025-01-01 00:00:00', '2026-12-31 23:59:59', NULL, NULL, 1, 0, 1, 1),
  (8, '10% off Headphones', 'Get 10% discount on all headphones and earbuds.', 'category_discount', 'percentage', 10.00, 3000.00, 5000.00, 5, '2025-01-01 00:00:00', '2026-12-31 23:59:59', NULL, NULL, 1, 0, 1, 1),
  (9, 'First order 20% off', 'Get 20% discount on your first order above 3000.', 'first_order', 'percentage', 20.00, 5000.00, 3000.00, 1, '2025-01-01 00:00:00', '2026-12-31 23:59:59', NULL, NULL, 1, 0, 1, 1),
  (10, 'Happy Hour 15% off', 'Get 15% discount during happy hours (2PM-4PM).', 'time_based', 'percentage', 15.00, 4000.00, 2000.00, 10, '2025-01-01 00:00:00', '2026-12-31 23:59:59', '14:00:00', '16:00:00', 1, 0, 1, 1);

-- Offer-Product/Category Mappings
INSERT INTO offer_product_category (offer_product_category_id, offer_id, product_id, category_id, is_active, is_deleted, created_by, updated_by) VALUES
  -- Offer 1: 10% off all phones (category_id=2 for Phones)
  (1, 1, NULL, 2, 1, 0, 1, 1),
  -- Offer 2: 2000 off Android phones (category_id=3 for Android Phones)
  (2, 2, NULL, 3, 1, 0, 1, 1),
  -- Offer 3: iPhone 15 launch offer (product_id=1 for iPhone 15 Pro Max)
  (3, 3, 1, NULL, 1, 0, 1, 1),
  -- Offer 5: 15% off Samsung phones (category_id=5 for Samsung Phones)
  (4, 5, NULL, 5, 1, 0, 1, 1),
  -- Offer 6: 3000 off Galaxy S series (product_id=2 for Galaxy S24 Ultra, product_id=3 for Galaxy A55)
  (5, 6, 2, NULL, 1, 0, 1, 1),
  (6, 6, 3, NULL, 1, 0, 1, 1),
  -- Offer 7: 20% off Laptops (category_id=43 for Laptops)
  (7, 7, NULL, 43, 1, 0, 1, 1),
  (8, 7, NULL, 44, 1, 0, 1, 1),
  (9, 7, NULL, 45, 1, 0, 1, 1),
  -- Offer 8: 10% off Headphones (category_id=26 for Headphones & Earbuds)
  (10, 8, NULL, 26, 1, 0, 1, 1),
  -- Offer 9: First order 20% off (no mapping needed - applies to all)
  -- Offer 10: Happy Hour 15% off (no mapping needed - applies to all)
  -- Additional mappings for variety
  (11, 1, 4, NULL, 1, 0, 1, 1),
  (12, 1, 5, NULL, 1, 0, 1, 1),
  (13, 2, 6, NULL, 1, 0, 1, 1),
  (14, 2, 7, NULL, 1, 0, 1, 1),
  (15, 8, 14, NULL, 1, 0, 1, 1),
  (16, 8, 15, NULL, 1, 0, 1, 1);

INSERT INTO offer_usage (offer_usage_id, offer_id, user_id, order_id, discount_amount, is_deleted, created_by, updated_by) VALUES
  -- Offer 1: 10% off all phones - Rahul used it on Order 1
  (1, 1, 2, 1, 10000.00, 0, 2, 2),
  -- Offer 3: iPhone 15 launch offer - Priya used it on Order 2
  (2, 3, 3, 2, 5000.00, 0, 3, 3),
  -- Offer 4: Flat 500 off orders above 5000 - Amit used it (no order yet)
  (3, 4, 4, NULL, 500.00, 0, 4, 4),
  -- Offer 1: 10% off all phones - Vikram used it (no order yet)
  (4, 1, 6, NULL, 8000.00, 0, 6, 6),
  -- Offer 5: 15% off Samsung phones - Rahul used it (no order yet)
  (5, 5, 2, NULL, 2000.00, 0, 2, 2),
  -- Offer 9: First order 20% off - Neha used it (no order yet)
  (6, 9, 5, NULL, 4000.00, 0, 5, 5),
  -- Offer 7: 20% off Laptops - Amit used it (no order yet)
  (7, 7, 4, NULL, 10000.00, 0, 4, 4),
  -- Offer 6: 3000 off Galaxy S series - Priya used it (no order yet)
  (8, 6, 3, NULL, 3000.00, 0, 3, 3),
  -- Offer 10: Happy Hour 15% off - Vikram used it (no order yet)
  (9, 10, 6, NULL, 1500.00, 0, 6, 6);
...
-- =====================
-- 15. Offer Integration with Cart
-- =====================
...
-- Add offer_id and discount_amount columns to cart_master table
