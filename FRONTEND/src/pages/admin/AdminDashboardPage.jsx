...
function AdminDashboardPage() {
  ...
  useEffect(() => {
    if (activeTab !== "offers" && offersMobileMenuOpen) {
      setOffersMobileMenuOpen(false);
    }
  }, [activeTab, offersMobileMenuOpen]);
  ...
  return (
    <div className={`admin-dashboard-grid grid items-start gap-6 p-6 ${sidebarOpen ? "lg:grid-cols-[290px_1fr]" : "lg:grid-cols-1"}`}>
        ...
        >
          <div className="mb-4 flex items-center gap-3">
            {activeTab === "offers" && (
              <Button
                type="button"
                onClick={() => setOffersMobileMenuOpen((prev) => !prev)}
                ...
                aria-label={offersMobileMenuOpen ? "Close menu" : "Open menu"}
              >
      ...
      {activeTab === "offers" && offersMobileMenuOpen && (
        <>
          <button
            type="button"
            aria-label="Close menu overlay"
            onClick={() => setOffersMobileMenuOpen(false)}
